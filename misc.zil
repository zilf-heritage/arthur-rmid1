...
"Haven't I seen you playing third base for the Red Sox?"
		...
		(<VERB? ATTACK>
			...
			<RT-AUTHOR-MSG
"Feeling self-desctructive? Dial 1-800-HIT-SELF for incredibly expensive but
absolutely worthless brochures from Masochists Anonymous. Call anytime - our
...
;	<COND
	...
	<CLEAR -1>
	<REPEAT ()
		<TELL "|Would you like to restore a saved position?" CR>
		<COND
			(<Y?>
				<V-RESTORE>
			)
...
shimmer in the polished steel:||" ,K-WHOSO-PULLETH-MSG ".||The local chieftain,
King Lot, has declared a curfew, and you know that even a boy such as yourself
would be thrown in prison should you be caught by his soldiers. Yet you have
come anyway, irresistibly drawn by this sword of mystery. Noblemen from far
and wide have tried and failed to draw the sword from the stone, yet something
inside urges you to try.||Slowly you approach the sword. Driven by some inner
force, you clasp your hand around the hilt. The two seem made for one another.
You pull. Nothing happens. You strain harder. The sword gives a little, and
then....|"
	>
