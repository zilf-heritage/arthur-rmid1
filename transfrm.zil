...
your avian form and continue flying." CR
		...
		(<AND <OR
			...
			; "Bob"
			<TELL
"You start the transformation, but you suddenly realize that you can't
breathe underwater, and quickly revert to your" formtype " form." CR
			>
		)
		(<AND <EQUAL? .FORM ,K-FORM-ARTHUR>
...
through life looking like a very long sausage-roll." CR
		...
		(<AND <EQUAL? .FORM ,K-FORM-ARTHUR>
			...
			<TELL
"You start the transformation back into a human. You suddenly realize that
the narrow confines of the tree are not large enough to accommodate your
human form, and you quickly revert to your" formtype " form. Had you actually
made the change and lived, you would have gone through life looking like a
very large pin-cushion." CR
			>
		)
		(<AND <EQUAL? .FORM ,K-FORM-ARTHUR>
...
" begins to throttle you, and you quickly revert to your" formtype " form." CR
		...
		(<AND <EQUAL? .FORM ,K-FORM-EEL>
			...
			<SETG GL-FORM-ABORT T>
			<TELL
"You start the transformation into an eel, but suddenly when you try to
breathe, your gills fill with dust instead of water. Rather than die of
suffocation, you quickly revert to your human form." CR
			>
		)
		(T
			<COND
