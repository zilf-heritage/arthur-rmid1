...
<ROUTINE RT-TH-RAVEN-EGG ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? EXAMINE>
			...
			<TELL The ,TH-RAVEN-EGG " looks quite massive." CR>
		)
		(<VERB? SIT>
			; "Bob"
			<TELL
The+verb ,WINNER "sit" " on" the ,TH-RAVEN-EGG " briefly, but nothing happens,
so" he+verb ,WINNER "get" " up again." CR
			>
		)
	>
>
...
The ,CH-RAVEN " is below you in" the ,RM-GROVE "." CR
				...
				(<IN? ,CH-RAVEN ,RM-RAVEN-NEST>
					<TELL
The ,CH-RAVEN " is in" the ,RM-RAVEN-NEST " at the top of" the ,RM-RAVEN-TREE
!\. CR
					>
				)
	...
	<COND
		...
		; "Bob"
			<COND
				...
				(<MC-HERE? ,RM-GROVE>
					<TELL
CR ,K-RAVEN-SWOOP-MSG "It looks extremely puzzled, and then flies back up." CR
					>
				)
			>
		)
						...
						(<MC-HERE? ,RM-GROVE>
							<COND
								(<FSET? ,CH-PLAYER ,FL-ASLEEP>
									; "Bob"
									<TELL
"You are suddenly awakened by the sound of something heavy crashing through
leaves and branches. You glance up just in time to see" the ,TH-BRASS-EGG
" crush you with a loud \"WHUMP!\"" CR
									>
									<RT-END-OF-GAME>
								)
								(T
...
<ROOM RM-ABOVE-FOREST
	...
	(GLOBAL LG-FOREST RM-RAVEN-NEST RM-RAVEN-TREE RM-GROVE)
...
<ROUTINE RT-RM-ABOVE-FOREST ("OPT" (CONTEXT <>))
	<COND
		(<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
			...
			<TELL
,K-FLY-HIGH-MSG " One tall tree sticks up above the rest. In its uppermost
branches is a huge nest"
			>
			<COND
...
<ROOM RM-RAVEN-NEST
	...
	(GLOBAL LG-FOREST RM-GROVE RM-RAVEN-TREE)
				...
				(<VERB? THROW PUT PUT-IN>
					<COND
						(<MC-HERE? ,RM-GROVE>
							; "Bob"
							<TELL
The+verb ,WINNER "have" "n't the strength to throw" the ,PRSO " that high." CR
							>
						)
					>
				)
