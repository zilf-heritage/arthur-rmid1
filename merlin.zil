...
<ROOM RM-OUTSIDE-CRYSTAL-CAVE
	...
	(GLOBAL RM-CRYSTAL-CAVE RM-MERPATH)
>
	...
	<COND
		(<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
			...
			<COND
				(<MC-CONTEXT? ,M-LOOK>
					<TELL
"You are" standing " in the clearing just to the south of Merlin's cave."
					>
				)
				(T
					<COND
						(<EQUAL? ,OHERE ,RM-MERPATH>
							<TELL
"The path ends in a clearing just to the south of a cave."
							>
						)
		...
		(<MC-CONTEXT? ,M-ENTERED>
			<COND
				(<NOT <FSET? ,CH-PLAYER ,FL-LOCKED>>
					...
					<TELL
"|Merlin looks up and says, \"Why hello, Arthur. I was just thinking about
...
form.\"||\"You see, as an animal, you could do things that humans can't. But
at least these things would not be done for you by spells. You would still
have to demonstrate the qualities which prove your worthiness to rule - and
at the same time you would be gaining respect for all forms of life.\"||His
dark eyes bore into you for a second and then he seems to reach a decision.
\"Yes. That is what we shall do.\" He glances down at the scroll. \"The
creatures here should be sufficient for our purpose. The owl, the badger,
the salamander, the eel, and the turtle.\"||Merlin waves his hand over you
and mumbles a few words. \"There. It is done. The word you will need is
'Cyr,' the ancient word of transformation. When you wish to become another
creature, say 'Cyr' and the name of that creature. Remember, however, that
the people fear sorcery - if someone is present when you change form, he may
kill you. Remember also that you cannot move directly from one foreign shape
to another. You must become human first.\"" CR
					>
				)
...
away and you are left in silence.||In the center of the room is a perfectly
round crystal ball. On the ground near the wall is a bag." CR
					>
				)
				(T
					<COND
		...
		(<VERB? EXAMINE LOOK-IN>
			<COND
				(<MC-HERE? ,RM-OUTSIDE-CRYSTAL-CAVE>
					...
					<TELL
"An eerie light seems to emanate from within the cave." CR
					>
				)
			>
		)
...
England.\"||\"Even though he is manacled, he still has power. When you cross
the river, you will find that my magic is no longer of any use to you. That
is his land. Go there only if you must.\"" CR
							>
						)
					>
				)
...
"\"It is the sword of destiny, meant to be wielded by you alone.\"" CR
				...
				(<MC-PRSI? ,TH-MAGIC-RING>
					<TELL
"\"It's magic is useful. Remember well the words of the man who gave
it to you.\"" CR
					>
				)
				(<MC-PRSI? ,TH-FUTURE-OBJECT ,CH-PLAYER> ;"Bob - I added ,CH-PLAYER"
					<TELL
...
<ROUTINE RT-TH-CRYSTAL-BALL ("OPT" (CONTEXT <>))
	<COND
		...
		(<TOUCH-VERB?>
			<TELL
"As you reach for the ball, the crystal walls of the cave start to vibrate
ominously and you wisely withdraw." CR
			>
		)
	>
>
...
<ROUTINE RT-TH-TORQUE ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? EXAMINE>
			...
			<TELL
The ,TH-TORQUE " is an open neckband made of twisted metal. It ends in two
knobs, and imbedded in one of the knobs is a sliver of "
			>
			<COND
