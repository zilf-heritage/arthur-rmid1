...
and keep safe until such time as England had need of you.\"||\"To you alone
belongs the throne of England, Arthur. But the time is not yet when you may
take up this sword. Before you gain your birthright, you must prove yourself
a king. To rule England you must be both wise and chivalrous. To lead her
armies you must be strong and courageous. I believe you have these qualities
within you, but you must demonstrate them for all to see. In so doing, you
will gain the experience you need to claim the sword.\"||\"Come seek me out
at my cave beyond the meadow, and I will help you achieve your quest. Be
warned, however, that another plots to steal your throne. Go, therefore, son
of Uther, to earn and protect that which is yours.\"||Merlin disappears as
suddenly as he came. In the space where he had been, a torque hangs in
mid-air for a second and then falls to the ground." CR
			>
		)
...
<ROUTINE RT-PS-FAKE-SOLDIERS ("OPT" (CONTEXT <>) (ART <>) (CAP? <>))
	<COND
		...
		(<VERB? LISTEN>
			<COND
				(<OR	<RT-IS-QUEUED? ,RT-I-SOLDIER-2>
						<RT-IS-QUEUED? ,RT-I-SOLDIER-3>
					>
					<TELL The ,CH-SOLDIERS "are" " muttering curses about the cold." CR>
				)
			>
		)
...
;	<FSET ,CH-SOLDIERS ,FL-NO-DESC>
	...
	<COND
		...
		(<MC-HERE? ,RM-CHURCH>
			<TELL " You look around quickly but see no place to hide." CR>
		)
	>
	<RTRUE>
>
...
of the church. Above his head, he brandishes a jeweled sword that looks
...
<ROUTINE RT-PS-BENCHES ("OPT" (CONTEXT <>) (ART <>) (CAP? <>))
	<COND
		...
		(<VERB? EXAMINE LOOK-ON>
			<THIS-IS-IT ,PSEUDO-OBJECT>
			<TELL "The benches look very uncomfortable." CR>
		)
		(<VERB? PUT SIT LIE-DOWN>
			<THIS-IS-IT ,PSEUDO-OBJECT>
			<TELL
"The bench seats are all tilted forward. " The ,WINNER " can't "
			>
			<COND
				(<VERB? PUT>
					<TELL "put anything">
