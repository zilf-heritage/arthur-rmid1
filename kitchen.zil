...
with his back to a" open ,TH-CUPBOARD " cupboard."
					...
					<COND
						(<IN? ,TH-BIRD ,TH-CAGE>
							...
							>
							<TELL ", as if he is trying to tell you something.">
						)
					>
					<COND
						(<AND <IN? ,TH-CHEESE ,TH-TAVERN-TABLE>
							...
							>
							<TELL
" Near the edge of the table is a small piece of cheese that it looks like
the cook has forgotten about."
							>
						)
					>
					<CRLF>
				...
				(T
					<TELL "You are in the tavern's small kitchen.|">
					<RFALSE>
				)
			>
		)
...
you through the heart." ,K-HEEDED-WARNING-MSG
								...
								(,GL-FORM-ABORT
									; "Bob"
									<TELL
"|Fortunately," the ,CH-COOK " didn't notice." CR
									>
								)
							>
						)
...
the Post Office.\"" CR
				...
				(<MC-PRSI? ,TH-CAGE>
					<TELL
"\"If you was just a little smaller, I'd pop you in there and keep
you for a pet. Har har.\"" CR
					>
				)
				(T
					<TELL "\"Don't know nuthin' 'bout no ">
...
<ROUTINE RT-TH-CAGE ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? ENTER>
			<COND
				(<RT-OBJ-TOO-LARGE? ,WINNER ,TH-CAGE>
...
tell you something." CR
		...
		(<AND <VERB? LISTEN>
			...
			>
			<TELL
"It sounds as if" the ,TH-BIRD " is trying to tell you something." CR
			>
		)
		(<AND <SPEAKING-VERB?>
				<MC-HERE? ,RM-TAV-KITCHEN>
		...
		(<VERB? EMPTY>
			<COND
				(<IN? ,TH-SPICE ,TH-SPICE-BOTTLE>
					<REMOVE ,TH-SPICE>
					<TELL
The+verb ,WINNER "pour" the ,TH-SPICE " out of" the ,TH-SPICE-BOTTLE ". It
scatters on" the ,TH-GROUND "." CR
					>
					<RT-SCORE-MSG 0 -1 0 0>
				)
				(<IN? ,TH-WATER ,TH-SPICE-BOTTLE>
