...
<ROUTINE RT-L-STARTLED-MSG ()
	...
	<RT-QUEUE ,RT-I-LEP-1 <+ ,GL-MOVES 3>>
	<TELL
"Momentarily startled, the leprechaun quickly recovers his composure and
leaps into the bushes at the edge of the clearing. As he disappears, his tiny
voice trails after him in triumph," ,K-SPRITE-MSG CR
	>
	<COND
		(<EQUAL? ,GL-WINDOW-TYPE ,K-WIN-PICT>
			<RT-UPDATE-PICT-WINDOW>
...
<ROUTINE RT-TH-WHISKY-JUG ("OPT" (CONTEXT <>) "AUX" N TBL OBJ)
	<COND
		...
		(<VERB? EXAMINE READ>
			...
			<SET N <WINGET -3 ,K-W-XSIZE>>
			<DIROUT ,K-D-TBL-ON ,K-DIROUT-TBL>
			<TELL "XXX">
			<DIROUT ,K-D-TBL-OFF ,K-DIROUT-TBL>
			<CURSET <WINGET -3 ,K-W-YCURPOS> </ <- .N <LOWCORE TWID>> 2>>
			<PRINTT <ZREST ,K-DIROUT-TBL 2> <ZGET ,K-DIROUT-TBL 0>>
			<CRLF>
			<DIROUT ,K-D-TBL-ON ,K-DIROUT-TBL>
			<TELL "MOTHER MACREE'S IRISH WHISKY">
			<DIROUT ,K-D-TBL-OFF ,K-DIROUT-TBL>
			<CURSET <WINGET -3 ,K-W-YCURPOS> </ <- .N <LOWCORE TWID>> 2>>
			<PRINTT <ZREST ,K-DIROUT-TBL 2> <ZGET ,K-DIROUT-TBL 0>>
			<CRLF>
...
<ROUTINE RT-GN-WHISKY (TBL FINDER)
	<COND
		(<EQUAL? <PARSE-ACTION ,PARSE-RESULT> ,V?DRINK>
			<RETURN ,TH-WHISKY>
		)
		(T
