...
; "file : JOUST.ZIL"
; "auth :   $Author:   DEB  $"
; "date :     $Date:   08 May 1989 16:56:28  $"
; "revs : $Revision:   1.89  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "Joust"
...
through with his lance.|"
						...
						(,GL-FORM-ABORT
							; "Bob"
							<TELL
"|Fortunately," the ,CH-BLUE-KNIGHT " didn't notice." CR
							>
						)
					>
				)
...
<ROUTINE RT-JOUST (LANCE "AUX" S L KS KL)
	...
	>
	<TELL
" one and fetches his horse from behind the pavilion. He unties your horse,
which canters a little distance away and then turns to face the blue knight.
...
which he hands to you.||\"Congratulations, old chap. Spoils of war,
what?\"||The knight stumbles around the clearing, cleaning up after the
joust. He ties the horse to the tree, collects the lances and disappears
into the pavilion.|"
			>
			<SETG GL-UPDATE-WINDOW <BOR ,GL-UPDATE-WINDOW ,K-UPD-OBJS>>
			<COND
...
bean. Care to try again?\"|"
			...
			<COND
				...
				(T
					<REMOVE ,CH-BLUE-KNIGHT>
					<TELL
"\"Pity. I'll be running along then. Cheerio!\" The knight disappears into
the pavilion.|"
					>
					<SETG GL-UPDATE-WINDOW <BOR ,GL-UPDATE-WINDOW ,K-UPD-OBJS>>
					<COND
...
<ROUTINE RT-TH-TREE ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? EXAMINE>
			...
			<FSET ,TH-HORN ,FL-SEEN>
			<TELL
"It's a large shade tree that has a horse tied to its trunk and a horn
hanging from one of its lower branches." CR
			>
		)
	>
>
...
horn. Otherwise I shall smite you.\""
						...
						(T
							...
							>
							<TELL
" says, \"I'm sorry to have to do this, old chap. But you leave me no
choice.\" He deals you a mighty blow that puts a dent in his mailed fist and
has the unfortunate side-effect of killing you.|"
							>
							<RT-END-OF-GAME>
						)
					>
...
<OBJECT TH-HORN-CHAIN
	(LOC RM-EDGE-OF-WOODS)
	(DESC "chains")
	(FLAGS FL-NO-DESC FL-PLURAL FL-TRY-TAKE)
...
<OBJECT TH-HORSE
	(LOC RM-EDGE-OF-WOODS)
	(DESC "horse")
	(FLAGS FL-ALIVE FL-NO-DESC FL-SEARCH FL-SURFACE FL-VEHICLE FL-TRY-TAKE)
	(SYNONYM HORSE)
...
<ROUTINE RT-HORSE-TIED ("OPT" (QUIET <>))
	<COND
		...
		(<IN? ,CH-BLUE-KNIGHT ,RM-EDGE-OF-WOODS>
			<TELL "The knight prevents you from leaving with his horse.|">
		)
		(T
			<TELL "The horse is tied to the tree.|">
		)
	>
	<RFALSE>
>
...
Let's have at it then.\"||The knight disappears into the pavilion for a
moment and then emerges carrying two lances that are identical save that one
is red and one is green. \"Mount up, lad,\" says the knight, \"And I shall
give you your choice of lances.\"|"
											>
											<SETG GL-UPDATE-WINDOW <BOR ,GL-UPDATE-WINDOW ,K-UPD-OBJS>>
											<COND
												(<EQUAL? ,GL-WINDOW-TYPE ,K-WIN-DESC>
...
The+verb ,WINNER "slide" " the chain mail on over" the ,TH-TUNIC "."
						...
						(T
							...
							<SET CR? T>
							<TELL
The+verb ,WINNER "wriggle" " into the chain mail." CR
							>
