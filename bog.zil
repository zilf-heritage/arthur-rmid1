...
<ROOM RM-MOOR
	...
	(IN TO RM-COTTAGE)
	(UP PER RT-FLY-UP)
	(GLOBAL LG-THATCH LG-PATH RM-COTTAGE RM-BOG)
	(ACTION RT-RM-MOOR)
>
...
northeast lies a large peat bog."
			...
			<COND
				(<MC-CONTEXT? ,M-F-LOOK>
					...
					;"Bob - shouldn't this be a separate paragraph (object listing)?"
					<TELL
...
<ROOM RM-COTTAGE
	...
	(SOUTH TO RM-MOOR)
	(OUT TO RM-MOOR)
	(GLOBAL LG-THATCH LG-WALL RM-MOOR)
	(GENERIC RT-GN-STONE)
				...
				(<AND <VERB? TRANSFORM>
					...
					<COND
						...
						(,GL-FORM-ABORT
							; "Bob"
							<TELL
"|Fortunately," the ,CH-PEASANT " didn't notice." CR
							>
						)
					>
				)
			...
			<COND
				(<VERB? PUT PUT-IN>
					<COND
						...
						(<MC-PRSO? ,CH-PLAYER ,TH-HANDS ,TH-LEGS ,TH-HEAD ,TH-MOUTH>
							<TELL ,K-HOT-MSG>
						)
...
filled with warmth.||After a few moments, the peasant begins to stir. When he
is fully conscious he sits up and looks from the fire to you. \"Why, God
bless you, sir,\" he says. \"There's not many would take pity on the likes of
me.\"|"
	>
	<RT-SCORE-MSG 10 0 0 0>
	<SETG GL-PICTURE-NUM ,K-PIC-COTTAGE-AWAKE>
...
<ROOM RM-EDGE-OF-BOG
	...
	(SW TO RM-MOOR)
	(UP PER RT-FLY-UP)
	(GLOBAL LG-PEAT RM-BOG RM-COTTAGE RM-MOOR)
...
vague outline of an island with what looks like a large thornbush on it. The
skies are clearer to the west and southwest, where you see the moor and roofs
of the town. The castle lies below you to the south, and to the east you can
see a road emerge from the fog and come to a ford in the river.|"
			>
			<RFALSE>
		)
		(<MC-CONTEXT? ,M-ENTER>
