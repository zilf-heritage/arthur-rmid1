...
; "file : ENDGAME.ZIL"
; "auth :   $Author:   RAB  $"
; "date :     $Date:   04 May 1989 12:37:04  $"
; "revs : $Revision:   1.71  $"
; "vers : 1.0"
;"---------------------------------------------------------------------------"
; "End Game Puzzle"
...
His eyes widen at the sight of the gold and he stoops to pick it up."
	>
>

<ROUTINE RT-I-LOT-TRICK ()
	<TELL
"Your attention is distracted by something at the edge of the crowd. Lot
siezes the moment to leap up, knock your sword aside and run you through.|"
	>
	<RT-END-OF-GAME>
>
...
<OBJECT TH-EXCALIBUR
	(LOC TH-STONE)
	(DESC "sword")
	(FLAGS FL-KNIFE FL-NO-DESC FL-TRY-TAKE)
...
cheers, \"Long Live King Arthur. The Once and Future King.\"||

Thank you for Beta testing this game.||"
							>
