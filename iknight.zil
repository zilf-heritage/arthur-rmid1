...
<ROOM RM-MEADOW
	...
	(UP PER RT-MEADOW-UP)
	(GLOBAL RM-PAVILION RM-MERPATH RM-FIELD-OF-HONOUR)
	(ACTION RT-RM-MEADOW)
			...
			<COND
				(<EQUAL? ,P-WALK-DIR ,P?EAST>
					<COND
						...
						(<NOT .QUIET>
							<TELL
The+verb ,WINNER "do" "n't see anything interesting in that " D ,INTDIR "." CR
							>
						)
					>
				)
...
A voice call after you, \"And stay out!\" " ,K-MERLIN-WASTED-MSG CR
					>
					<RT-END-OF-GAME>
				)
			>
...
<ROUTINE RT-TH-BRASS-EGG ("OPT" (CONTEXT <>))
	<COND
		...
		(<VERB? SIT>
			; "Bob"
			<TELL
The+verb ,WINNER "sit" " on" the ,TH-BRASS-EGG " briefly, but nothing happens,
