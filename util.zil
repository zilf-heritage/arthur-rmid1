...
<ROUTINE V-VERSION ()
	<HLIGHT ,K-H-BLD>
	<TELL
"Arthur: The Quest for Excalibur" CR
...
<ROUTINE RT-END-OF-GAME ("OPT" (WIN? <>) (REPEAT <>) "AUX" VAL (MSG? T) (M? <>))
	<UPDATE-STATUS-LINE>
	<COND
		(<NOT .REPEAT>
			<CRLF>
...
friend - when you have need of me, I will be there.||Before I go, I shall"
							>
						)
						(T
							<TELL
