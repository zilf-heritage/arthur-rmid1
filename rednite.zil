...
<ROUTINE RT-CH-RED-KNIGHT ("OPT" (CONTEXT <>))
	<COND
		(<MC-CONTEXT? ,M-WINNER>
			<COND
				(<AND <VERB? TELL-ABOUT>
...
"You" walk " past the knight onto the causeway that leads south to the island."
				...
				(T
; "Bob - If you take off from the causeway and then land, this is the message
	that you will get. Is this right?"
					<TELL
