...
<ROUTINE RT-RM-CASTLE-GATE ("OPT" (CONTEXT <>) "AUX" PW)
	<COND
		(<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
			...
			<TELL
"You are" standing " outside the gate to the castle of evil King Lot. "
A+verb ,CH-SOLDIERS "are" " standing guard"
			>
			<COND
				...
				(<EQUAL? ,OHERE ,RM-PARADE-AREA>
					<COND
						(<EQUAL? ,GL-PUPPY ,CH-PRISONER>
							...
							<TELL
"|The smith pulls you out of earshot of the guard and whispers, \"I am
...
again.\"||The smith walks off toward the town gate and quickly disappears
from sight.|"
							>
...
through the heart with" his ,CH-SOLDIERS " sword." ,K-HEEDED-WARNING-MSG
						...
						(,GL-FORM-ABORT
							; "Bob"
							<TELL
"|Fortunately," the ,CH-SOLDIERS " didn't notice." CR
							>
						)
					>
				)
...
"|The soldier recognizes the prisoner and" ,K-GUARDS-COME-MSG
      ...
      (<MC-CONTEXT? ,M-F-LOOK ,M-V-LOOK ,M-LOOK>
         ...
         <TELL
"You are now in the parade area of King Lot's castle. The gate in the west
wall is guarded by a soldier. The armoury is to the south, the entrance to
the great hall is to the east, and the kitchen is to the southeast.|"
         >
         <RFALSE>
      )
		(<MC-CONTEXT? ,M-END>
		...
		(<MC-CONTEXT? ,M-ENTERED>
			<COND
				(<IN? ,CH-PRISONER ,RM-GREAT-HALL>
					<TELL
"|After a few moments, Lot happens to glance at your companion. Suddenly,
he leaps to his feet as he recognizes the smith. He points at the two of you
and calls out, \"Guards! Arrest them!\" His guards quickly close around you"
					>
					<COND
...
<OBJECT CH-COURTIERS
	...
	(SYNONYM COURTIERS MOB CROWD PEOPLE)
...
they are afraid of King Lot." CR
				...
				(<AND <NOT <FSET? ,CH-LOT ,FL-BROKEN>>
					...
					>
					; "Bob"
					<TELL The+verb ,CH-COURTIERS "are" " awaiting the outcome of the battle." CR>
				)
				(T
					; "Bob"
...
mangy dog!\" But the guards quickly overwhelm you and carry you off to a
cold, dark dungeon where you spend the rest of your days counting the hairs
on your arm." CR
					>
					<RT-END-OF-GAME>
				)
